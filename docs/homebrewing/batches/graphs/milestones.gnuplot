...
# setup graph
set term png size 1200,HEIGTH
output_file = "2025_milestones.png"
set output output_file
set key outside right center vertical Left reverse enhanced autotitle nobox

set title "Milestones 2025"
set style data lines
set timefmt "%d-%m-%Y"
...
set xdata time
set format x "%m-%Y"
set xrange ["01-01-2025":"31-12-2025"]
...
# setup graph
set term png size 1200,HEIGTH
output_file = "2026_milestones.png"
set output output_file
set key outside right center vertical Left reverse enhanced autotitle nobox

set title "Milestones 2026"
set style data lines
set timefmt "%d-%m-%Y"
...
set xdata time
set format x "%m-%Y"
set xrange ["01-01-2026":"31-12-2026"]
